...
cpt= 0
for i in range(150):
    num_data = interpolation(sort(do_load_2d_array('/Users/cheng/Documents/dat/CTSAWorkspace/sequence9/GTS/'+ ''.join(["navi" + str(i).rjust(8, '0')])+'.raw.txt')), 0.5)
    #exp_data = interpolation(sort(do_load_2d_array('/Users/cheng/Documents/dat/evaluation/2/'+str(10000+i)+'_2.txt')), 0.5)
    exp_data = interpolation(sort(do_load_2d_array('/Users/cheng/Desktop/compare/sequence9/prediction/sequence17_' + str(10000 + i) + '_1.csv')), 0.5)
